...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <br><br><br><br>
    <div class="container purple lighten-4">
      ...
      <form action="./Cadastro_Cliente.php" method = "POST" class="col s12 m12">
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">portrait</i>
            <label for = "Input_Id_Cpf">Id_Cpf:</label>
            <input type = "text" name = "Input_Id_Cpf" id = "Input_Id_Cpf">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">account_box</i>
            <label for = "Input_Nome_Cliente">Nome_Cliente</label>
            <input type = "text" name = "Input_Nome_Cliente" id = "Input_Nome_Cliente" >
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12 center">
            <button id ="btMais" class = "center btn-large waves-effect waves-light green"> + </button>
          </div>
        </div>
        <div>
            <table>
