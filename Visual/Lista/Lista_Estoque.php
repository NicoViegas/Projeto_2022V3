...
<body style="background-image: url(https://preview.redd.it/zx2xkd615eb41.png?auto=webp&s=7cabfaad8db92c973c0d77a256532e9e45d5c53a); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
      ...
      <table class = "highlight centered responsive-table purple lighten-3">
        ...
        <tbody>
            <tr style = "background-color: green">
                <?php
                    require_once '../../CLASSES_Modelo/Estoque.php';
                    require_once '../../DAO/DAO_Estoque.php';
                    require_once '../../DAO/conexao.php';

                    $dao = new DAO_Estoque();
                    $lista = $dao->ListaEstoque();
