...
<body style="background-image: url(https://i.redd.it/dps8im1r7gf81.png); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">

  <!--Bara de navegação-->
  <nav class="purple lighten-1" role="navigation">
    <div class="nav-wrapper container">
      <!--Logo a empresa-->
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-med-and-down" style= "white-space: nowrap;">PADEIROS CADASTRADOS</a>
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-large-only" style= "white-space: nowrap;">PADEIROS:</a>
            ...
            <tr>
              <?php
                ...
                foreach ($lista as $linha) {
                    echo '<tr>';
                    echo '<td>' . $linha['Id_Pade'] . '<?td>';
                    echo '<td>' . $linha['Nom_Pade'] . '<?td>';
                    echo '<td>' . $linha['CPF_Pade'] . '<?td>';
                    echo '<td>' . $linha['Idade_Pade'] . '<?td>';
                    echo '<td>  
                        <form action = "../Exclusao/Exclui_Padeiros.php" method = "POST">
                            <input type="hidden" name = "id" value="' . $linha['Id_Pade'] . '">
