...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <nav class="purple lighten-1" role="navigation">
    <div class="nav-wrapper container">
      <!--Logo a empresa-->
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-med-and-down" style= "white-space: nowrap;">ALIMENTOS CADASTRADOS</a>
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-large-only" style= "white-space: nowrap;">ALIMENTOS:</a>
      ...
      <table class = "highlight centered responsive-table purple lighten-3">
        ...
        <tbody>
            ...
            foreach ($lista as $linha) {
                ...
                echo '<td>' . $linha['Id_Alimento'] . '<?td>';
                echo '<td>' . $linha['Nome_Ali'] . '<?td>';
                echo '<td>' . $linha['Preco_KG'] . '<?td>';
                echo '</tr>';
            };
            ?>   
            </tr>
