  ...
  <br><br><br><br>
        <div class="section no-pad-bot" id="index-banner">
            ...
            <?php
                ...
                $Id_Pade = filter_input(INPUT_POST, 'Input_Id_Pade');
                $Id_Alimentos = filter_input(INPUT_POST, 'Input_Id_Alimentos');
                $Nome_Ali= filter_input(INPUT_POST, 'Input_Nome_Ali');
                $Preco_KG = filter_input(INPUT_POST, 'Input_Preco_KG');
                
                $alimentos = new Alimentos($Id_Pade,null, $Nome_Ali, $Preco_KG);
                $DAO_Alimentos = new DAO_Alimentos();
                if($DAO_Alimentos -> incluiAlimento($alimentos))
                {
