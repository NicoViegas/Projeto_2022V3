...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <nav class="purple lighten-1" role="navigation">
    <div class="nav-wrapper container">
      <!--Logo a empresa-->
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-med-and-down" style= "white-space: nowrap;">CADASTRAR ALIMENTOS</a>
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-large-only" style= "white-space: nowrap;">C: ALIMENTOS</a>
  ...
  <br><br><br><br>
    <div class="container purple lighten-4">
      ...
      <form action="./Cadastro_Alimentos.php" method = "POST" class="col s12 m12">
        <div class="row">¨
            <div class="input-field col s12">
                <i class="material-icons prefix">portrait</i>
                <label for = "Input_Id_Pade"></label>
                <select name = "Input_Id_Pade" id = "Input_Id_Pade">
                        <?php
        ...
        <div class="row">
          <div class="input-field col s12">
            ...
            <label for = "Input_Nome_Ali">Nome do Alimento: </label>
            <input type = "text" name = "Input_Nome_Ali" id = "Input_Nome_Ali">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">attach_money</i>
            <label for = "Input_Preco_KG">Preço Kilo:</label>
            <input type = "text" name = "Input_Preco_KG" id = "Input_Preco_KG">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12 center">
            <button class = "center btn-large waves-effect waves-light green"> Salvar </button>
          </div>
        </div>
      </div>
    </form>
