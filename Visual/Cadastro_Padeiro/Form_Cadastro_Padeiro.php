...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <br><br><br><br>
    <div class="container purple lighten-4">
      ...
      <form action="./Cadastro_Padeiro.php" method = "POST" class="col s12 m12">
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">account_circle</i>
            <label for = "Input_Nom_Pade">Nome Padeiro:</label>
            <input type = "text" name = "Input_Nom_Pade" id = "Input_Nom_Pade">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">portrait</i>
            <label for="Input_CPF_Pade">CPF do Padeiro(a)</label>
            <input name = "Input_CPF_Pade" id="Input_CPF_Pade" type="text" class="validate">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <i class="material-icons prefix">import_export</i>
            <label for="Input_Idade_Pade">Idade do Padeiro(a)</label>
            <input name = "Input_Idade_Pade" id="Input_Idade_Pade" type="number" class="validate">
          </div>
        </div>
        <div class="row">
