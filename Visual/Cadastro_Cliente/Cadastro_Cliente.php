...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <nav class="purple lighten-1" role="navigation">
    <div class="nav-wrapper container">
      <!--Logo a empresa-->
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-med-and-down" style= "white-space: nowrap;">CADASTRAR Clientes</a>
      <a id="logo-container" href="../../index.html" class="brand-logo  hide-on-large-only" style= "white-space: nowrap;">C: Clientes</a>
  ...
  <br><br><br><br>
        <div class="section no-pad-bot" id="index-banner">
            ...
            <?php
                ...
                //troca os input aí burror
                $Id_Cpf = filter_input(INPUT_POST, 'Input_Id_Cpf');
                $Nom_Cliente = filter_input(INPUT_POST, 'Input_Nome_Cliente');
                $Cliente = new Cliente($Id_Cpf, $Nom_Cliente);

                $DAO_Cliente = new DAO_Cliente();
                if($DAO_Cliente -> incluiCliente($Cliente))
                {
