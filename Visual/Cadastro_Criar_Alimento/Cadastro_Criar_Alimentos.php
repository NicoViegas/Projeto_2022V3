...
<body style="background-image: url(https://i.pinimg.com/236x/19/d9/51/19d95128926c03fbfab2dd1bb647b971.jpg); background-repeat: no-repeat; background-size: cover; background-clip: content-box;">
  ...
  <br><br><br><br>
        <div class="section no-pad-bot" id="index-banner">
            ...
            <?php
                require_once '../../CLASSES_Modelo/Criar_Alimento.php';
                require_once '../../DAO/DAO_Criar_Alimento.php';
                require_once '../../DAO/conexao.php';

                //Pegando Com Filtragem
                $Id_Alimento = filter_input(INPUT_POST, 'Input_Id_Alimento');
                $Quantidade_Ali = filter_input(INPUT_POST, 'Input_Quantidade_Ali');
                $Criar_Alimento = new Criar_Alimento($Id_Alimento,$Quantidade_Ali);
                $DAO_Criar_Alimento = new DAO_Criar_Alimento();
                if($DAO_Criar_Alimento -> incluiCriar_Alimento($Criar_Alimento))
                {
